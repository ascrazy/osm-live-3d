...
refresh-tiles:
	docker run -it --rm -v ./strandedkitty-planetiler:/usr/src/planetiler -w /usr/src/planetiler maven:3.8.3-openjdk-17 java -cp planetiler-dist/target/*-with-deps.jar com.onthegomap.planetiler.examples.StreetsProfile
